...
public class LogIntegratedPersistenceTest {
  ...
  public void anEmptyLogReturnsDefaultValuesForIndexesAndTermsAndConfigurations() throws Exception {
    withReplicatorLog(new CheckedConsumer<ReplicatorLog, Exception>() {
      @Override
      public void accept(ReplicatorLog log) throws Exception {
  ...
  public void rollsKeepingTrackOfTermCorrectly() throws Exception {
    withOpenOLog(new CheckedConsumer<OLog, Exception>() {
      @Override
      public void accept(OLog oLog) throws Exception {
